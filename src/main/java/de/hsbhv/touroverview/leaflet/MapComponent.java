...
public class MapComponent extends PolymerTemplate<TemplateModel> implements HasSize {
     ...
     * {@link MapComponent#addMarkerClickListener(ComponentEventListener)}
     */
    public static class MarkerClickEvent extends ComponentEvent<MapComponent> {
        private final MapLocation marker;

        public MarkerClickEvent(MapComponent source, boolean fromClient, MapLocation marker) {
     ...
     * <p>
     * This is the event received when registering for
     * {@link MapComponent#addMapClickListener(ComponentEventListener)}
     */
    @DomEvent("map-click") // Defined in JS method _mapClicked()
    public static class MapClickEvent extends ComponentEvent<MapComponent> {

        private double latitude;
        private double longitude;

        public MapClickEvent(MapComponent source, boolean fromClient, @EventData("event.detail.lat") double latitude,
     ...
     * {@link MapComponent#MapComponent()}
     * <p>
    ...
    public static class InternalMarkerClickEvent extends ComponentEvent<MapComponent> {
        private final Integer id;

        public InternalMarkerClickEvent(MapComponent source, boolean fromClient, @EventData("event.detail.id") Integer id) {
            super(source, fromClient);
            this.id = id;
        }
